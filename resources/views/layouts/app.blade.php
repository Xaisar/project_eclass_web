...
@section('content')
  ...
  <div id="layout-wrapper">
    ...
    <div class="main-content">
      ...
      <div class="page-content">
        {{-- <v-loader>
                    <div class="loader-content">
                        <h2><strong><i class="fa fa-spinner fa-spin"></i></strong></h2>
                        <p>Memuat...</p>
                    </div>
                </v-loader> --}}
      ...
      @role('Siswa')
        @include('layouts.partials.bottom_bar')
      @endrole
    </div>
    <!-- ============================================================== -->
  ...
  <script src='{{ asset('assets/libs/jitsi/external_api.js') }}'></script>
