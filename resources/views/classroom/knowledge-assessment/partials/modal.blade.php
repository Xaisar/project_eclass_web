                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="home1" role="tabpanel">
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-12">
                                        <label for="">Pertemuan Ke <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col">
                                        <select name="number_of_meeting" id="number_of_meeting" class="form-control js-choices">
                                            <option value="">Pilih Pertemuan</option>
                                            @for ($i = 1; $i <= $numberOfMeetings; $i++)
                                                <option value="{{ hashId($i) }}" {{ isset($assignment) && $assignment->number_of_meeting == $i ? 'selected' : '' }}>{{ $i }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <select name="scheme" class="form-control js-choices">
                                            ...
                                            <option value="writing_test" {{ isset($assignment) && $assignment->scheme == 'writing_test' ? 'selected' : ''}}>Tes Tulis</option>
                                            <option value="oral_test" {{ isset($assignment) && $assignment->scheme == 'oral_test' ? 'selected' : ''}}>Tes Lisan</option>
                                            <option value="assignment" {{ isset($assignment) && $assignment->scheme == 'assignment' ? 'selected' : ''}}>Tugas</option>
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-12 py-2">
                                        <label for="">Penilaian Harian Ke <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col">
                                        <input type="number" name="day_assessment" class="form-control" placeholder="Penilaian Harian Ke" autocomplete="off" value="{{ isset($assignment) ? $assignment->day_assessment : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        @if(isset($assignment))
                                                ...
                                                <select name="basic_competence" id="basic_competence" class="form-control js-choices">
                                                    ...
                                                    @foreach($basicCompetence as $item)
                                                        ...
                                                        @endforeach
                                                        <option value="{{ $item->hashid }}" {{ in_array($item->hashid, $hashid) ? 'selected' : '' }}>{{ $item->coreCompetence->code }}.{{ $item->code }} {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                        @else
                                            {{-- <label for="{{ $item->hashid }}">
                                            ...
                                            <select name="basic_competence" id="basic_competence" class="form-control js-choices">
                                                <option value="">Pilih Kompetensi Dasar (KD)</option>
                                                @foreach($basicCompetence as $item)
                                                <option value="{{ $item->hashid }}">{{ $item->coreCompetence->code }}.{{ $item->code }} {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        @endif
                                    </div>
