                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="mt-4" action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="email" type="text" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Enter email">
                                        @error('email')
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">Remember It ?  <a href="{{ route('auth') }}"
