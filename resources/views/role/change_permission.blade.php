...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('roles') }}" data-toggle="ajax">Roles</a></li>
...
@section('content')
    <div class="card shadow-sm p-3 mb-3">
        <div class="card-body">
            <form action="{{ route('roles.update-permission', $id) }}" method="post" data-request="ajax"
                ...
                <button class="btn btn-secondary float-end mx-1" type="button" data-toggle="ajax"
                    data-target="{{ route('roles') }}"><i class="fa fa-arrow-left"></i> Kembali</button>
            </form>
        </div>
    </div>
@endsection
