...
@section('content')
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-body">
            ...
            <table id="dataTable" class="table align-middle datatable dt-responsive table-check nowrap"
                ...
                data-url="{{ route('class-groups.getData') }}" width="100%">
    ...
    @include('class_group.partials.form')
@endsection
