                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <form action="{{ $action }}" method="post" data-request="ajax"
                            data-success-callback="{{ route('teachers.profile') }}" enctype="multipart/form-data">
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="">NUPTK/NIK (Username) <span class="text-danger">*</span></label>
                                            <input type="text" name="identity_number" id="identity_number"
                                                class="form-control" placeholder="NUPTK / NIK" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="year_of_entry" id="year_of_entry"
                                                class="form-control" placeholder="Tahun Masuk" autocomplete="off"
                                                value="{{ Auth::user()->userable->year_of_entry }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="last_education" id="last_education"
                                                class="form-control" placeholder="Pendidikan Terakhir" autocomplete="off"
                                                value="{{ Auth::user()->userable->last_education }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-footer text-end">
                                <button class="btn btn-light waves-effect waves-light mx-1" data-toggle="ajax"
                                    data-target="{{ route('teachers.profile') }}"><i class="fa fa-arrow-left"></i>
                                    Kembali</button>
